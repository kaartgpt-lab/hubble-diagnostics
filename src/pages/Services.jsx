        ...
        <div className="container mx-auto px-4 sm:px-8 flex flex-col md:flex-row items-center md:items-center justify-between gap-4 md:gap-0">
          ...
          <div className="mt-2 md:mt-0">
            <button
              ...
              className="bg-white text-[#122056] font-semibold px-4 py-2 rounded-sm hover:bg-[#e1f0ff] transition text-m"
            >
              Contact Us
            </button>
          </div>
          ...
          {services.map((s, i) => (
            //<motion.div key={s.slug} custom={i} variants={cardVariant}>
              ...
              >
                ...
                <div className="p-5">
                  <h3 className="text-[#122056] font-semibold text-lg mb-2">
                    {s.title}
                  </h3>
